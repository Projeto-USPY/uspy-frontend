...
const Stats : React.FC<{}> = () => {
	...
	return (
		<Grid container justify='center' alignItems='center' style={{ gap: '15px' }}>
			<Grid item>
				<img style={{ maxHeight: '3em', height: 'auto' }} src={subjectStatIcon} alt='Icone de um livro'/>
				<p>{stats.subjects ?? '0'} disciplinas</p>
			</Grid>
			<Grid item>
				<img style={{ maxHeight: '3em', height: 'auto' }} src={offeringStatIcon} alt='Icone de uma silhueta com um interrogação'/>
				<p>{stats.offerings ?? '0'} oferecimentos</p>
			</Grid>
			<Grid item>
				<img style={{ maxHeight: '3em', height: 'auto' }} src={userStatIcon} alt='Icone de um capelo'/>
				<p>{stats.users ?? '0'} usuários</p>
			</Grid>
			<Grid item>
				<img style={{ maxHeight: '3em', height: 'auto' }} src={gradeStatIcon} alt='Icone de uma folha de prova'/>
				<p>{stats.grades ?? '0'} notas</p>
			</Grid>
			<Grid item>
				<img style={{ maxHeight: '3em', height: 'auto' }} src={commentStatIcon} alt='Icone de um balão de comentário'/>
