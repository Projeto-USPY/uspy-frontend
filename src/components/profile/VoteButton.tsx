...
export const VoteButton: React.FC<VoteButtonPropsType> = ({
	type,
	filled,
	onClick,
	color = 'primary',
...
export const VoteButtonGroup: React.FC<VoteButtonGroupPropsType> = ({
	record,
	color = 'primary',
	size = 'small',
}) => {
		...
		<>
			{['down', 'up'].map((type) => (
				<VoteButton
					...
					size={size}
					filled={
						subjectReview?.categories.worth_it === (type === 'up')
					}
