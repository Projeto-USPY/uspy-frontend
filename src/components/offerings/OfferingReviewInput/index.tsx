...
const OfferingReviewInput: React.FC<PropsType> = ({ content, limit, rows, onChange, placeholder, disabled }) => {
	...
	return <div className="offering-review-input-wrapper" style={disabled ? { color: 'rgba(0, 0, 0, 0.38)' } : {}}>
		{React.useMemo(() => <div
			ref={ref1}
			style={style}
