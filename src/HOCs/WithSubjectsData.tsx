...
import api from 'API'
export const CourseDataContext: React.Context<CourseComplete> = createContext(null)
...
const WithSubjectsData = ({ children, course, specialization }: WithSubjectsDataProps) => {
    ...
    useEffect(() => {
        api.getSubjectList(course, specialization).then((courseData) => {
