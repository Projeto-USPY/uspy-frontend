		...
		Subjects: [
			{
				...
				Description:
					'Apresentar ao aluno um panorama da evolução da computação, identificando marcos históricos, personagens relevantes e suas contribuições. Motivar o aluno ingressante por meio da apresentação de desenvolvimentos e aplicações importantes da computação em diferentes áreas, relacionando-os aos fundamentos matemáticos a serem estudados ao longo do curso.',
				ClassCredits: 2,
				AssignCredits: 0,
				TotalHours: '30 h',
				Requirements: [],
			...
			},
			{
				...
				Description:
					'Familiarizar o aluno com a utilização de instrumentos de medidas mecânicas, organização de tabelas e gráficos com escala lineares e logarítmicas obtidos em Física I. Introduzir os fundamentos básicos da teoria de Erros e do Método dos Mínimos Quadrados. Utilizar os tópicos anteriores para a realização de práticas e confecção de relatórios sobre experimentos básicos de mecânica.',
				ClassCredits: 2,
				AssignCredits: 0,
				TotalHours: '30 h',
				Requirements: null,
			...
			},
			{
				...
				Description:
					'Apresentar aos alunos ideias mais avançadas de tópicos em Ciências de Computação, incluindo teoria e prática.',
				ClassCredits: 3,
				AssignCredits: 2,
				TotalHours: '105 h',
				Requirements: [],
			...
			},
			{
				...
				Description:
					'Introduzir o aluno aos aspectos conceituais e tecnológicos associados ao projeto e avaliação de sistemas computacionais com requisitos de tempo-real.',
				ClassCredits: 3,
				AssignCredits: 0,
				TotalHours: '45 h',
				Requirements: ['SSC0140'],
				Optional: true,
			},
			{
				Code: 'SCC0215',
			...
			},
			{
				...
				Name: 'Cálculo II',
				Description:
					'Familiarizar os alunos com os resultados fundamentais relativos a: integração definida, técnicas de integração, diferenciabilidade de funções de várias variáveis e extremos de funções de várias variáveis.',
				ClassCredits: 4,
				AssignCredits: 0,
				TotalHours: '60 h',
				Requirements: ['SMA0353'],
				Optional: false,
			},
			{
				Code: 'SMA0180',
			...
			},
			{
				...
				Description:
					'Apresentar ao aluno conceitos fundamentais da interação entre o usuário e o computador. Capacitar o aluno a discutir os tópicos envolvidos em áreas atuais de pesquisa. Dar ao aluno experiência na avaliação de interfaces.',
				ClassCredits: 4,
				AssignCredits: 2,
				TotalHours: '120 h',
				Requirements: ['SSC0103'],
				Optional: true,
			},
			{
				Code: 'SCC0286',
			...
			},
			{
				...
				Description:
					'Introduzir o aluno às técnicas, teorias e modelos utilizados na Web Semântica, tornando-o apto a desenvolver recursos, ferramentas e aplicações computacionais que envolvam a aplicação desse conhecimento na resolução de problemas na área de aplicações Web. Capacitar o aluno para discutir criticamente tópicos pertinentes à área e propiciar-lhe subsídios para desenvolvimento de pesquisas.',
				ClassCredits: 4,
				AssignCredits: 1,
				TotalHours: '90 h',
				Requirements: ['SCC0216', 'SMA0180'],
				Optional: true,
			},
			{
				Code: 'SCC0240',
			...
			},
			{
				...
				Description:
					'Permitir que o aluno demonstre capacidade empreendedora, descrevendo e documentando projetos desenvolvidos por empresa formalmente constituída, da qual ele é sócio atuante.',
				ClassCredits: 4,
				AssignCredits: 10,
			...
			},
			{
				...
				Description:
					'Apresentar alguns conceitos avançados importantes e seus impactos no projeto e implementação de aplicações de comunicação em geral, com ênfase em redes móveis, multimídia, segurança e gerenciamento de redes de computadores.',
				ClassCredits: 4,
				AssignCredits: 2,
				TotalHours: '120 h',
				Requirements: ['SSC0142'],
				Optional: true,
			},
			{
				Code: 'SCC0225',
			...
			},
			{
				...
				Description:
					'Apresentar os conceitos básicos em comunicação, redes de computadores e a internet.',
				ClassCredits: 4,
				AssignCredits: 2,
				TotalHours: '120 h',
				Requirements: ['SSC0140'],
			...
			},
			{
				...
				Description:
					'Introduzir conceitos de modelagem de séries temporais utilizando ferramentas oriundas da Estatística e da área de Sistemas Dinâmicos.',
				ClassCredits: 2,
				AssignCredits: 2,
				TotalHours: '90 h',
				Requirements: ['SCC0202', 'SMA0354', 'SME0141'],
				Optional: true,
			},
			{
				Code: 'SSC0115',
			...
			},
			{
				...
				Description:
					'\tComplementar a formação dos alunos em Engenharia de Software abordando com mais profundidade tópicos atuais e relevantes nesta área.',
				ClassCredits: 3,
				AssignCredits: 0,
				TotalHours: '45 h',
				Requirements: ['SSC0130'],
				Optional: true,
			},
			{
				Code: 'SCC0244',
			...
			},
			{
				...
				Description:
					'Estimular a pró-atividade dos alunos, incentivando-os a desempenhar atividades extracurriculares de sua escolha.',
				ClassCredits: 1,
				AssignCredits: 1,
				TotalHours: '45 h',
				Requirements: [],
			...
			},
			{
				...
				Description:
					'O objetivo desta disciplina é o de permitir ao estudante que desenvolva atividades relevantes para sua formação em empresas ou universidades/centros de pesquisa durante período de intercâmbio oficialmente reconhecido.',
				ClassCredits: 4,
				AssignCredits: 10,
				TotalHours: '360 h ( Estágio: 300 h )',
				Requirements: [],
			...
			},
			{
				...
				Description:
					'Introduzir ao aluno conceitos de robótica inteligente, apresentando as principais técnicas de controle inteligente, a eficiência destes métodos quando usados adequadamente, perspectivas futuras e aplicações de Robótica Móvel.',
				ClassCredits: 3,
				AssignCredits: 1,
				TotalHours: '75 h',
				Requirements: ['SCC0201'],
			...
			},
			{
				...
				Description:
					'Capacitar o aluno a discutir aspectos da legislação brasileira relativos à Tecnologia da Informação e Comunicação (TIC) , e a especificar projeto no qual esses aspectos estejam contemplados.',
				ClassCredits: 2,
				AssignCredits: 1,
				TotalHours: '60 h',
				Requirements: [],
			...
			},
			{
				...
				Description:
					'O objetivo principal desta disciplina é que o aluno crie o costume de participar de atividades extracurriculares que são de grande importância para sua formação e que ao mesmo tempo adquira conhecimentos e visões adicionais de diferentes áreas da computação',
				ClassCredits: 1,
				AssignCredits: 0,
				TotalHours: '15 h',
				Requirements: [],
			...
			},
			{
				...
				Description:
					'Aprofundar os conhecimentos adquiridos na disciplina Sistemas Computacionais Distribuídos e Programação Concorrente, através de uma abordagem prática.',
				ClassCredits: 3,
				AssignCredits: 3,
				TotalHours: '135 h',
				Requirements: ['SSC0143', 'SSC0150'],
				Optional: true,
			},
			{
				Code: 'SCC0252',
			...
			},
			{
				...
				Description:
					'Apresentar ao aluno conceitos relativamente avançados de Sistemas Embarcados e de Sistemas Evolutivos e aplicações deles em conjunto para otimização e projeto de sistemas em geral.',
				ClassCredits: 2,
				AssignCredits: 0,
				TotalHours: '30 h',
				Requirements: ['SCC0221', 'SSC0112'],
				Optional: true,
			},
			{
				Code: 'SCC0213',
				...
				Description:
					'Este curso tem por objetivo introduzir os alunos no domínio de elementos básicos da pesquisa científica possibilitando-lhes condições de desenvolver projetos acadêmicos de estudo na área de computação.',
				ClassCredits: 2,
				AssignCredits: 1,
				TotalHours: '60 h',
				Requirements: [],
			...
			},
			{
				...
				Description:
					'Fornecer aos alunos uma visão ampla e prática sobre segurança computacional.',
				ClassCredits: 2,
				AssignCredits: 1,
				TotalHours: '60 h',
				Requirements: ['SSC0900'],
				Optional: true,
			},
			{
				Code: 'SCC0270',
			...
			},
			{
				...
				Description:
					'Objetivo: Fornecer conceitos, técnicas e características mais avançadas dos Sistemas Gerenciadores de Bases de Dados, complementando o conteúdo ministrado nas disciplinas básicas de bases de dados. Oferecer o conhecimento necessário ao profissional que se envolva em atividade de administração e gerenciamento de bases de dados.',
				ClassCredits: 4,
				AssignCredits: 2,
				TotalHours: '120 h',
				Requirements: ['SCC0240'],
				Optional: true,
			},
			{
				Code: 'SCC0282',
			...
			},
			{
				...
				AssignCredits: 1,
				TotalHours: '60 h',
				Requirements: ['SCC0202', 'SSC0140', 'SSC0142'],
				Optional: true,
			},
			{
				Code: 'SCC0261',
				Name: 'Multimídia',
				Description:
					'Introdução aos conceitos de multimídia e investigação dos problemas envolvidos com o suporte computacional a dados de mídia e de aplicações multimídia.',
				ClassCredits: 2,
				AssignCredits: 0,
				TotalHours: '30 h',
				Requirements: ['SCC0201'],
			...
			},
			{
				...
				Name: 'Cálculo I',
				Description:
					'Fazer com que os alunos familiarizem-se com os conceitos de limite, continuidade, diferenciabilidade e primitivas de funções de uma variável.',
				ClassCredits: 4,
				AssignCredits: 0,
				TotalHours: '60 h',
				Requirements: [],
			...
			},
			{
				...
				Description:
					'O objetivo principal desta disciplina é abordar tópicos variados de gestão organizacional, de forma generalista, apresentando aos alunos uma visão geral das várias frentes da gestão, contribuindo para sua formação técnica e humanística em seu futuro profissional.',
				ClassCredits: 1,
				AssignCredits: 1,
				TotalHours: '45 h',
				Requirements: [],
			...
			},
			{
				...
				Description:
					'Estudo e aplicação de diferentes técnicas de modelagem e ferramentas para avaliação de desempenho de sistemas computacionais.',
				ClassCredits: 3,
				AssignCredits: 1,
				TotalHours: '75 h',
				Requirements: ['SSC0114'],
				Optional: true,
			},
			{
				Code: 'SSC0741',
			...
			},
			{
				...
				Description:
					'Treinamento do aluno em aspectos de especificação, instalação, e administração de sistemas computacionais baseados em redes de computadores.',
				ClassCredits: 3,
				AssignCredits: 2,
				TotalHours: '105 h',
				Requirements: ['SSC0142'],
			...
			},
			{
				...
				Description:
					'Implementar e experimentar em laboratório as técnicas e os algoritmos introduzidos aos alunos nas disciplinas de programação cursadas em conjunto. Preparar o aluno para registro de medidas em algoritmos para confecção de relatórios sobre experimentos realizados com os algoritmos implementados e para resolução de problemas de programação.',
				ClassCredits: 4,
				AssignCredits: 0,
				TotalHours: '60 h',
				Requirements: ['SCC0201'],
			...
			},
			{
				...
				Description:
					'Propiciar ao aluno ferramental para projetar, desenvolver e avaliar aplicações e serviços de software como recursos computacionais de Tecnologia Assistiva.',
				ClassCredits: 4,
				AssignCredits: 1,
				TotalHours: '90 h',
				Requirements: ['SSC0130'],
			...
			},
			{
				...
				Description:
					'\tApresentar conhecimentos, habilidades e técnicas utilizadas na iniciação, planejamento, execução, controle e encerramento de um projeto.',
				ClassCredits: 3,
				AssignCredits: 1,
				TotalHours: '75 h',
				Requirements: [],
			...
			},
			{
				...
				Description:
					'O objetivo do curso é introduzir aos alunos os conceitos fundamentais de modelagem e simulação como uma ferramenta para a resolução de problemas na ciência em geral, e na área de ciência da computação em específico.',
				ClassCredits: 3,
				AssignCredits: 2,
				TotalHours: '105 h',
				Requirements: ['SCC0202', 'SSC0140'],
				Optional: true,
			},
			{
				Code: 'SSC0119',
				...
				Description:
					'Desenvolver projetos práticos nas áreas de arquiteturas básicas de processadores, de microcomputadores e de linguagens de máquina em laboratório.',
				ClassCredits: 2,
				AssignCredits: 1,
				TotalHours: '60 h',
				Requirements: ['SSC0112'],
			...
			},
			{
				...
				Description:
					'Fornecer aos alunos  uma visão integrada (em termos de legislação, dos recursos de Tecnologia Assistiva, e os princípios de design inclusivo)  sobre a questão de acessibilidade como um conceito fundamental  ao desenvolvimento dos sistemas computacionais.',
				ClassCredits: 2,
				AssignCredits: 1,
				TotalHours: '60 h',
				Requirements: ['SSC0130'],
			...
			},
			{
				...
				Description:
					'Fornecer ao aluno familiarização com técnicas de recuperação de dados complexos, bem como conhecimento e prática dos conceitos básicos e aplicações.',
				ClassCredits: 3,
				AssignCredits: 2,
				TotalHours: '105 h',
				Requirements: ['SCC0241', 'SCC0261'],
				Optional: true,
			},
			{
				Code: 'SCC0633',
			...
			},
			{
				...
				Name: 'Redes Móveis',
				Description:
					'Apresentar os conceitos básicos em mobilidade, tecnologias de redes móveis sem fio e em projetos de sistemas baseados em localização.',
				ClassCredits: 3,
				AssignCredits: 2,
				TotalHours: '105 h',
				Requirements: ['SSC0142'],
			...
			},
			{
				...
				Description:
					'\tAtualização do estudante em tópicos atuais da área de Sistemas de Computação.',
				ClassCredits: 3,
				AssignCredits: 0,
				TotalHours: '45 h',
				Requirements: [],
			...
			},
			{
				...
				Description:
					'Transmitir aos alunos conceitos sobre Internet das Coisas, considerando seus aspectos relacionados ao hardware e ao software, com vistas ao desenvolvimento de aplicações inovadoras para a resolução de problemas do mundo real.',
				ClassCredits: 2,
				AssignCredits: 2,
				TotalHours: '90 h',
				Requirements: [],
			...
			},
			{
				...
				Description:
					'Estender o conhecimento do aluno em técnicas digitais, com ênfase no projeto de circuitos sequenciais.',
				ClassCredits: 2,
				AssignCredits: 1,
				TotalHours: '60 h',
				Requirements: ['SSC0117'],
				Optional: false,
			},
			{
				Code: '7600105',
				...
				Description:
					'Ensinar aos estudantes os conceitos básicos da Mecânica Newtoniana e os métodos da Física como ciência. Capacitá-los a formular e resolver problemas referentes ao movimento de corpos e sistemas de corpos sob ação de forças.',
				ClassCredits: 4,
				AssignCredits: 0,
				TotalHours: '60 h',
				Requirements: ['SMA0353'],
			...
			},
			{
				...
				Description:
					'Desenvolvimento de aplicações práticas utilizando Sistemas Gerenciadores de Bases de Dados relacionais e ferramentas de apoio. Consolidação da teoria desenvolvida na disciplina SCC0240 Bases de Dados.',
				ClassCredits: 4,
				AssignCredits: 2,
				TotalHours: '120 h',
				Requirements: ['SCC0240'],
			...
			},
			{
				...
				Description:
					'\tO aprendizado dos conceitos básicos, principais técnicas, perspectivas futuras e aplicações de Bioinformática.',
				ClassCredits: 3,
				AssignCredits: 2,
				TotalHours: '105 h',
				Requirements: ['SCC0215', 'SCC0216'],
			...
			},
			{
				...
				Description:
					'Introduzir ao aluno conceitos básicos de eletrônica elógica Digital, técnicas de projeto de subsistemas digitais com ênfase em circuitos combinacionais.',
				ClassCredits: 2,
				AssignCredits: 1,
				TotalHours: '60 h',
				Requirements: [],
			...
			},
			{
				...
				Description:
					'\tDesenvolver a capacidade empreendedora dos alunos, estimulando e dando ferramentas àqueles cuja vocação profissional estiver direcionada à criação de um empreendimento em informática.',
				ClassCredits: 4,
				AssignCredits: 1,
				TotalHours: '90 h',
				Requirements: [],
			...
			},
			{
				...
				Description:
					'O objetivo principal desta disciplina é que o aluno crie o hábito de participar de atividades extracurriculares que são de grande importância para sua formação e que ao mesmo tempo adquira conhecimentos e visões adicionais de diferentes áreas da computação.',
				ClassCredits: 1,
				AssignCredits: 0,
				TotalHours: '15 h',
				Requirements: ['SCC0227'],
				Optional: true,
			},
			{
				Code: 'SME0878',
	...
	},
	{
		...
		Subjects: [
			...
			},
			{
				...
				Description:
					'Complementação da formação profissional específica. Adaptação psicológica, social e técnica do aluno à sua futura atividade profissional. Treinamento do aluno com vistas a facilitar sua futura absorção profissional. Orientação do aluno para a escolha de sua especialização profissional.',
				ClassCredits: 4,
				AssignCredits: 10,
				TotalHours: '360 h ( Estágio: 300 h )',
				Requirements: [
			...
			},
			{
				...
				Description:
					'Os principais objetivos desta disciplina são estudar e analisar algumas das principais teorias de aprendizagem de modo que o licenciado identifique o processo ensino-aprendizagem como complexo e dinâmico; e discutir temáticas relacionadas com o cotidiano escolar, de um ponto de vista psicológico.',
				ClassCredits: 4,
				AssignCredits: 2,
				TotalHours:
					'120 h ( Práticas como Componentes Curriculares = 30 h )',
				Requirements: [],
				Optional: true,
			},
			{
			...
			},
			{
				...
				AssignCredits: 2,
				TotalHours: '120 h',
				Requirements: ['SMA0802', 'SMA0804', 'SSC0800'],
				Optional: true,
			},
			{
				Code: 'SME0822',
			...
			},
			{
				...
				Description:
					'Propiciar um acompanhamento do progresso acadêmico e de formação dos alunos no 1o. semestre do curso, detectando-se os problemas gerais e propondo soluções.',
				ClassCredits: 1,
				AssignCredits: 0,
				TotalHours: '15 h',
				Requirements: [],
			...
			},
			{
				...
				Description:
					'Introduzir os princípios básicos da qualidade e as principais normas associadas a sistemas da qualidade. Apresentar as ferramentas estatísticas mais utilizadas no desenvolvimento da metodologia 6 Sigma.',
				ClassCredits: 4,
				AssignCredits: 0,
				TotalHours: '60 h',
				Requirements: ['SME0818'],
			...
			},
			{
				...
				Description:
					'Dar uma visão das principais técnicas de amostragem.',
				ClassCredits: 4,
				AssignCredits: 0,
				TotalHours: '60 h',
				Requirements: ['SME0818'],
			...
			},
			{
				...
				Description:
					'Oferecer aos estudantes do Bacharelado em Estatística habilidades práticas de consultoria e comunicação, como apresentar resultados verbalmente e em um relatório escrito e trabalhar em cooperação com outros pesquisadores. Fornecer tópicos metodológicos e conceituais à Consultoria Estatística.',
				ClassCredits: 4,
				AssignCredits: 0,
				TotalHours: '60 h',
				Requirements: ['SME0803'],
				Optional: true,
			},
			{
				Code: 'IAU0314',
			...
			},
			{
				...
				AssignCredits: 0,
				TotalHours: '60 h',
				Requirements: ['SMA0801', 'SMA0804', 'SSC0800'],
				Optional: false,
			},
			{
				Code: 'SME0880',
				...
				Description:
					'Dar suporte ao estudante no desenvolvimento de um projeto de  pesquisa  na área de Estatística, a fim de permitir uma visão mais global das áreas de Estatística, através da elaboração de um projeto assistido por docente.',
				ClassCredits: 4,
				AssignCredits: 10,
				TotalHours: '360 h ( Estágio: 300 h )',
				Requirements: [
			...
			},
			{
				...
				Description:
					'Apresentar ao estudante a organização de um trabalho acadêmico e desenvolver a habilidade de elaboração de um projeto relacionado com Estatística, enfatizando a importância da forma escrita para a comunicação de resultados.',
				ClassCredits: 2,
				AssignCredits: 2,
				TotalHours: '90 h',
				Requirements: [],
			...
			},
			{
				...
				Description:
					'Familiarizar o aluno ao curso e suas características e oferecer uma visão geral dos processos de Ciência de Dados pelo desenvolvimento de um projeto prático de pequena escala, assim como apoiar o aluno por meio de atividades de tutoria acadêmica.',
				ClassCredits: 4,
				AssignCredits: 2,
				TotalHours: '120 h',
				Requirements: [],
			...
			},
			{
				...
				Description:
					'Aprimoramento de conhecimentos específicos de uma determinada área de estatística. Proporcionar aprendizado específico de acordo com o interesse da maioria dos alunos de uma determinada turma.',
				ClassCredits: 4,
				AssignCredits: 0,
				TotalHours: '60 h',
				Requirements: ['SME0818'],
			...
			},
			{
				...
				Name: 'Biologia I',
				Description:
					'Permitir que os alunos adquiram conhecimentos sobre Origem da vida e evolução, Biologia celular e histologia. Prepará-los para que possam estabelecer parâmetros que os possibilitem extrair deste aprendizado um conteúdo adequado para o ensino de Ciências.',
				ClassCredits: 4,
				AssignCredits: 2,
				TotalHours:
					'120 h ( Práticas como Componentes Curriculares = 30 h )',
			...
			},
			{
				...
				Name: 'Bioestatística',
				Description:
					'Fornecer ao aluno conceitos básicos sobre epidemiologia clínica e bioestatística.',
				ClassCredits: 4,
				AssignCredits: 0,
				TotalHours: '60 h',
				Requirements: ['SME0803', 'SME0820'],
				Optional: true,
			},
			{
				Code: 'SCC0270',
			...
			},
			{
				...
				Name: 'Demografia',
				Description:
					'Apresentar ao estudante técnicas de análise demográficas e atuariais.',
				ClassCredits: 4,
				AssignCredits: 0,
				TotalHours: '60 h',
				Requirements: ['SME0805'],
				Optional: true,
			},
			{
				Code: 'SME0803',
				...
				Description:
					'Fornecer ao aluno conhecimentos sobre as principais técinicas estatísticas para descrição dos dados de acordo com os objetivos específicos da pesquisa. Ilustrar a aplicação das técnicas a conjuntos de dados reais, utilizando-se os principais pacotes estatísticos.',
				ClassCredits: 4,
				AssignCredits: 2,
				TotalHours: '120 h',
				Requirements: [],
			...
			},
			{
				...
				Description:
					'Apresentar técnicas específicas de planejamento de experimentos com aplicações em indústria,  finanças, medicina e outros.',
				ClassCredits: 4,
				AssignCredits: 2,
				TotalHours: '120 h',
				Requirements: ['SME0818'],
			...
			},
			{
				...
				Description:
					'Apresentar métodos e teoria de análise de dados categorizados.',
				ClassCredits: 4,
				AssignCredits: 0,
				TotalHours: '60 h',
				Requirements: ['SME0818'],
			...
			},
			{
				...
				Name: 'Biologia II',
				Description:
					'Permitir que os alunos adquiram conhecimentos sobre o Reino Animal e noções gerais de anatomo-fisiologia animal comparada. Prepará-los para que possam estabelecer parâmetros que os possibilitem extrair deste aprendizado um conteúdo adequado para o ensino de Ciências.',
				ClassCredits: 4,
				AssignCredits: 2,
				TotalHours:
					'120 h ( Práticas como Componentes Curriculares = 30 h )',
			...
			},
			{
				...
				Description:
					'Introduzir fundamentos básicos de análise de sobrevivência e de confiabilidade.',
				ClassCredits: 4,
				AssignCredits: 0,
				TotalHours: '60 h',
				Requirements: ['SME0818'],
		...
		Subjects: [
			{
				...
				AssignCredits: 0,
				TotalHours:
					'60 h ( Práticas como Componentes Curriculares = 30 h )',
				Requirements: [],
				Optional: false,
			},
			{
			...
			},
			{
				...
				AssignCredits: 0,
				TotalHours:
					'0 h ( Atividades Acadêmicos-Científico-Culturais = 100 h )',
				Requirements: [],
				Optional: true,
			},
			{
				...
				AssignCredits: 2,
				TotalHours:
					'120 h ( Práticas como Componentes Curriculares = 60 h )',
				Requirements: ['SMA0356'],
				Optional: true,
			},
			{
				Code: 'SMA0381',
			...
			},
			{
				...
				Description:
					'A finalidade é ajudar o estudante a descobrir como e o porquê do aparecimento e desenvolvimento das principais teorias matemáticas. A ênfase será dada sobre as teorias que melhor possam esclarecer conceitos elementares e indispensáveis tanto ao professor secundário quanto ao futuro pesquisador.',
				ClassCredits: 3,
				AssignCredits: 1,
				TotalHours: '75 h',
				Requirements: ['SMA0305', 'SMA0332'],
				Optional: true,
			},
			{
				Code: '7600108',
			...
			},
			{
				...
				Description:
					'Acompanhar o progresso acadêmico dos alunos no 1o. semestre do curso para entender os problemas gerais e específicos, propondo a soluções gerais e específicas que contribuam na formação do aluno.',
				ClassCredits: 1,
				AssignCredits: 0,
				TotalHours: '15 h',
				Requirements: [],
			...
			},
			{
				...
				Description:
					'Apresentar algumas aplicações da teoria dos conjuntos à matemática.',
				ClassCredits: 4,
				AssignCredits: 0,
				TotalHours: '60 h',
				Requirements: ['SMA0380'],
				Optional: true,
			},
			{
				Code: 'SME0202',
			...
			},
			{
				...
				Description:
					'Apresentar ao aluno algumas ferramentas e, principalmente, o modo de se trabalhar com objetivos lineares e similares.',
				ClassCredits: 4,
				AssignCredits: 0,
				TotalHours: '60 h',
				Requirements: [],
			...
			},
			{
				...
				AssignCredits: 0,
				TotalHours: '60 h',
				Requirements: ['SMA0332', 'SMA0356', 'SME0240'],
				Optional: false,
			},
			{
				Code: 'SCC0276',
			...
			},
			{
				...
				Description:
					'Familiarizar o aluno com algumas aplicações da topologia à Análise, principalmente ligadas aos teoremas: ponto fixo de Banach, de Baire, de Brouwer, de Stone-Weierstrass e o de Ascoli.',
				ClassCredits: 4,
				AssignCredits: 0,
				TotalHours: '60 h',
				Requirements: ['SMA0343', 'SMA0380'],
				Optional: true,
			},
			{
				Code: 'SMA0139',
				...
				Description:
					'Introduzir o estudante nos principais tópicos da teoria  elementar dos números e dar uma visão histórica de alguns dos  problemas clássicos desta teoria.',
				ClassCredits: 4,
				AssignCredits: 0,
				TotalHours: '60 h',
				Requirements: ['SMA0341'],
			...
			},
			{
				...
				Description:
					'Fornecer aos alunos da Licenciatura conhecimentos que subsidiem a utilização crítica da História da Matemática como um possível recurso pedagógico para o ensino de Matemática.',
				ClassCredits: 3,
				AssignCredits: 1,
				TotalHours: '75 h',
				Requirements: [],
			...
			},
			{
				...
				Name: 'Física I',
				Description:
					'Apresentar conceitos fundamentais de Mecânica para massas pontuais.',
				ClassCredits: 5,
				AssignCredits: 0,
				TotalHours: '75 h',
				Requirements: [],
			...
			},
			{
				...
				AssignCredits: 2,
				TotalHours:
					'120 h ( Práticas como Componentes Curriculares = 55 h )',
				Requirements: ['SMA0178'],
				Optional: true,
			},
			{
				Code: 'SME0221',
			...
			},
			{
				...
				AssignCredits: 0,
				TotalHours: '60 h',
				Requirements: ['SMA0300', 'SMA0332', 'SMA0375'],
				Optional: false,
			},
			{
				Code: 'SCC0244',
	...
	},
	{
		...
		Subjects: [
			...
			},
			{
				...
				Description:
					'Fornecer os conhecimentos básicos da mecânica dos fluidos, destacando a aplicação aos processos e às máquinas térmicas.',
				ClassCredits: 4,
				AssignCredits: 0,
				TotalHours: '60 h',
				Requirements: null,
			...
			},
			{
				...
				Description:
					'Familiarização do estudante com técnicas numéricas de geração de malhas computacionais para resolução de problemas que são modelados por equações diferenciais parciais.',
				ClassCredits: 4,
				AssignCredits: 2,
				TotalHours: '120 h',
				Requirements: ['SMA0333'],
				Optional: true,
			},
			{
				Code: 'SCC0230',
			...
			},
			{
				...
				Description:
					'Familiarização do estudante com técnicas numéricas para a solução das equações que modelam escoamentos incompressíveis.',
				ClassCredits: 4,
				AssignCredits: 2,
				TotalHours: '120 h',
				Requirements: ['SME0205', 'SME0206'],
				Optional: true,
			},
			{
				Code: 'SME0256',
			...
			},
			{
				...
				Description:
					'Familiarização do estudante com técnicas do método de elementos finitos para a solução de problemas de modelagem matemática.',
				ClassCredits: 4,
				AssignCredits: 0,
				TotalHours: '60 h',
				Requirements: ['SME0203'],
				Optional: true,
			},
			{
				Code: 'SCC0215',
			...
			},
			{
				...
				AssignCredits: 0,
				TotalHours: '60 h',
				Requirements: ['SME0803', 'SME0820', 'SME0822'],
				Optional: true,
			},
			{
				Code: 'SCC0272',
			...
			},
			{
				...
				Description:
					'Familiarizar o aluno com os conceitos e métodos básicos de Geometria Computacional.',
				ClassCredits: 4,
				AssignCredits: 0,
				TotalHours: '60 h',
				Requirements: [],
			...
			},
			{
				...
				Description:
					'Permitir que o aluno avançado no curso (com no mínimo 100 créditos cursados) se familiarize com o ambiente onde poderá exercer sua profissão. Além disso, dar-lhe uma visão mais abrangente da área e a possibilidade de trabalhar junto a uma equipe desenvolvendo um projeto da prática profissional.',
				ClassCredits: 4,
				AssignCredits: 10,
				TotalHours: '360 h ( Estágio: 300 h )',
				Requirements: [],
			...
			},
			{
				...
				Description:
					'Familiarização do estudante com técnicas de representação e resolução  prática de modelos geométricos.',
				ClassCredits: 4,
				AssignCredits: 0,
				TotalHours: '60 h',
				Requirements: [],
			...
			},
			{
				...
				Description:
					'Propiciar um acompanhamento do progresso acadêmico dos alunos no 1o. semestre do curso, detectando-se os problemas gerais e propondo soluções, além de guiar a formação do aluno.',
				ClassCredits: 2,
				AssignCredits: 0,
				TotalHours: '30 h',
				Requirements: [],
			...
			},
			{
				...
				Description:
					'Capacitar o aluno a perceber, formular e resolver problemas práticos de otimização.',
				ClassCredits: 4,
				AssignCredits: 2,
				TotalHours: '120 h',
				Requirements: ['SME0212', 'SME0213'],
				Optional: true,
			},
			{
				Code: 'SME0243',
			...
			},
			{
				...
				Description:
					'Permitir que o aluno avançado no curso (com no mínimo 100 créditos cursados) se familiarize com o ambiente científico-acadêmico, onde poderá exercer sua profissão. Além disso, dar-lhe uma visão mais abrangente da área e a possibilidade de trabalhar junto a uma equipe desenvolvendo um projeto da prática profissional.',
				ClassCredits: 4,
				AssignCredits: 10,
				TotalHours: '360 h ( Estágio: 300 h )',
				Requirements: [],
			...
			},
			{
				...
				Description:
					'Capacitar o aluno a perceber, formular e resolver problemas de fluxos em redes.',
				ClassCredits: 4,
				AssignCredits: 2,
				TotalHours: '120 h',
				Requirements: ['SME0211'],
			...
			},
			{
				...
				AssignCredits: 2,
				TotalHours: '120 h',
				Requirements: ['SMA0332', 'SMA0375', 'SME0230'],
				Optional: true,
			},
			{
				Code: 'SME0213',
	...
	},
	{
		...
		Subjects: [
			...
			},
			{
				...
				Name: 'Laboratório de Bases de Dados',
				Description:
					'Desenvolvimento de aplicações práticas utilizando sistemas gerenciadores de bancos de dados relacionais e ferramentas de apoio. Consolidação da teoria desenvolvida na disciplina de Bases de Dados.',
				ClassCredits: 4,
				AssignCredits: 2,
				TotalHours: '120 h',
				Requirements: ['SCC0540'],
				Optional: false,
			},
			{
				Code: 'SCC0268',
			...
			},
			{
				...
				Name: 'Bases de Dados',
				Description:
					'Fornecer conceitos, técnicas e características básicas dos sistemas gerenciadores de banco de dados, tornando o aluno capaz de desenvolver sistemas de informação centrados na busca de informações armazenadas em banco de dados.',
				ClassCredits: 4,
				AssignCredits: 1,
				TotalHours: '90 h',
				Requirements: ['SCC0503'],
				Optional: false,
			},
			{
				Code: 'SCC0282',
			...
			},
			{
				...
				Description:
					'Apresentar aos alunos tópicos atuais de interesse na área de banco de dados, que não são cobertos pelas disciplinas obrigatórias do curso. O conteúdo específico da disciplina varia de acordo com o interesse dos alunos e das tendências do ambiente profissional de produção de software.',
				ClassCredits: 2,
				AssignCredits: 0,
				TotalHours: '30 h',
				Requirements: ['SCC0540'],
			...
			},
			{
				...
				Description:
					'Avançar na investigação do estado-da-arte em termos do relacionamento das tecnologias de multimídia e hipermídia com as demais tecnologias da computação, como por exemplo redes de computadores, banco de dados, sistemas distribuídos, computação ubíqua, interação usuário-computador e visualização da informação. Tem também por objetivo motivar a realizar programa de Iniciação Científica e fortalecer a ligação da graduação com a pós-graduação do departamento, incentivando alunos de graduação a participarem do programa trilha graduação-mestrado.',
				ClassCredits: 3,
				AssignCredits: 0,
				TotalHours: '45 h',
				Requirements: ['SCC0268'],
				Optional: true,
			},
			{
				Code: 'SME0102',
			...
			},
			{
				...
				AssignCredits: 0,
				TotalHours: '30 h',
				Requirements: ['SCC0503', 'SCC0530', 'SCC0540'],
				Optional: true,
			},
			{
				Code: 'SCC0504',
			...
			},
			{
				...
				Name: 'Administração e Gerenciamento de Redes',
				Description:
					'Treinamento do aluno em aspectos de especificação, instalação, e administração de sistemas e serviços de redes de computadores.',
				ClassCredits: 2,
				AssignCredits: 1,
				TotalHours: '60 h',
				Requirements: ['SSC0540'],
				Optional: true,
			},
			{
				Code: 'SSC0529',
			...
			},
			{
				...
				Description:
					'Apresentar métodos e algoritmos básicos para agrupamento de dados. Abordar conceitos básicos sobre validação de grupos de dados. Apresentar aplicações práticas de ferramentas para agrupamento de dados.',
				ClassCredits: 2,
				AssignCredits: 2,
				TotalHours: '90 h',
				Requirements: ['SME0520'],
			...
			},
			{
				...
				Description:
					'Introdução dos conceitos de álgebra vetorial, geometria e álgebra linear.',
				ClassCredits: 4,
				AssignCredits: 0,
				TotalHours: '60 h',
				Requirements: [],
			...
			},
			{
				...
				Description:
					'O propósito deste curso é conscientizar os estudantes de alguns dos problemas que surgem, para o indivíduo e sociedade, com a introdução dos computadores digitais. Espera-se, ainda, que o curso ajude os estudantes a tomarem ciência de suas futuras responsabilidades como profissionais em computação.',
				ClassCredits: 2,
				AssignCredits: 0,
				TotalHours: '30 h',
				Requirements: [],
			...
			},
			{
				...
				Name: 'Sistemas Computacionais Distribuídos',
				Description:
					'Introdução aos conceitos básicos de sistemas computacionais distribuídos às técnicas de implementação e ao estudo de casos.',
				ClassCredits: 2,
				AssignCredits: 1,
				TotalHours: '60 h',
				Requirements: ['SSC0541'],
			...
			},
			{
				...
				Description:
					'Capacitar os alunos para a modelagem dos processos básicos do planejamento e controle da produção, e para o uso dos correspondentes métodos e técnicas de solução.',
				ClassCredits: 4,
				AssignCredits: 1,
				TotalHours: '90 h',
				Requirements: ['SSC0527'],
			...
			},
			{
				...
				Name: 'Projeto de Graduação I',
				Description:
					'Desenvolver no estudante o espírito, a mentalidade de pesquisa e a capacidade de síntese. Permitir que consiga ter uma visão mais global das áreas de computação através da elaboração de um projeto assistido por docente.',
				ClassCredits: 4,
				AssignCredits: 8,
				TotalHours: '300 h',
				Requirements: [],
			...
			},
			{
				...
				Description:
					'Introdução aos conceitos básicos de contabilidade e seu uso para orçamento de projetos.',
				ClassCredits: 2,
				AssignCredits: 0,
				TotalHours: '30 h',
				Requirements: [],
			...
			},
			{
				...
				Name: 'Estágio Supervisionado II',
				Description:
					'Permitir que o aluno se familiarize com o ambiente similar ao do exercício de sua profissão. Além disso, dar-lhe uma visão mais abrangente da área e a possibilidade de trabalhar junto a uma equipe desenvolvendo um projeto da prática profissional.',
				ClassCredits: 4,
				AssignCredits: 10,
				TotalHours: '360 h ( Estágio: 300 h )',
				Requirements: [],
			...
			},
			{
				...
				Description:
					'Estimular a pro-atividade dos alunos, incentivando-se a desempenharem atividades extras, de sua escolha.',
				ClassCredits: 0,
				AssignCredits: 1,
				TotalHours: '30 h',
				Requirements: [],
			...
			},
			{
				...
				Description:
					'Apresentar ao aluno modelos matemáticos para problemas práticos e técnicas avançadas de otimização. Motivar a Iniciação Científica e fortalecer a ligação da graduação com a pós-graduação do departamento, incentivando alunos de graduação a participarem da trilha graduação/pós-graduação.',
				ClassCredits: 3,
				AssignCredits: 0,
				TotalHours: '45 h',
				Requirements: ['SCC0502'],
			...
			},
			{
				...
				Description:
					'\tIntroduzir os conceitos básicos de estatística, com ênfase para sua aplicação prática na área de computação.',
				ClassCredits: 4,
				AssignCredits: 0,
				TotalHours: '60 h',
				Requirements: ['SMA0501'],
				Optional: false,
			},
			{
				Code: 'SSC0512',
				...
				Description:
					'Introduzir ao aluno conceitos básicos de eletrônica, Lógica Digital e técnicas de projeto de subsistemas digitais.',
				ClassCredits: 3,
				AssignCredits: 0,
				TotalHours: '45 h',
				Requirements: [],
			...
			},
			{
				...
				Description:
					'\tAvançar os conhecimentos obtidos pelos alunos em redes de computadores, adicionando conceitos fundamentais de tecnologia de alta velocidade e de Qualidade de Serviço principalmente com vistas à transmissão de mídia contínua.',
				ClassCredits: 2,
				AssignCredits: 1,
				TotalHours: '60 h',
				Requirements: ['SSC0540'],
			...
			},
			{
				...
				Description:
					'Capacitar o aluno a compreender os limites e pressupostos da teoria da organização na perspectiva da modelagem organizacional.',
				ClassCredits: 2,
				AssignCredits: 1,
				TotalHours: '60 h',
				Requirements: [],
			...
			},
			{
				...
				Description:
					'Introduzir os conceitos básicos de Sistemas de Informação, bem como os fundamentos e tendências de tecnologias e de sistemas de informação no contexto das organizações. Estudo de Caso do uso de SI em organizações.',
				ClassCredits: 2,
				AssignCredits: 0,
				TotalHours: '30 h',
				Requirements: [],
			...
			},
			{
				...
				Name: 'Hipermídia',
				Description:
					'Apresentar os fundamentos da tecnologia de hipermídia, abordando questões relevantes à arquitetura, modelagem, especificação, construção e usabilidade de aplicações hipermídia de modo geral, e daquelas que manipulam hiperdocumentos estruturados para a WWW de modo particular.',
				ClassCredits: 2,
				AssignCredits: 0,
				TotalHours: '30 h',
				Requirements: ['SCC0503'],
			...
			},
			{
				...
				Description:
					'Complementar a formação dos alunos em Sistemas Distribuídos abordando com mais profundidade tópicos atuais e relevantes nesta área.',
				ClassCredits: 2,
				AssignCredits: 0,
				TotalHours: '30 h',
				Requirements: ['SSC0540'],
			...
			},
			{
				...
				Description:
					'Apresentar ao aluno idéias mais avançadas da Inteligência Artificial e os problemas de implementação de sistemas de Inteligência Artificial',
				ClassCredits: 2,
				AssignCredits: 1,
				TotalHours: '60 h',
				Requirements: ['SCC0530'],
			...
			},
			{
				...
				Description:
					'Apresentação de várias abordagens de Avaliação da Qualidade de Sistemas Computacionais de acordo com padrões de qualidade de software, com ênfase na análise de desempenho e na avaliação da qualidade de produto e de pacotes.',
				ClassCredits: 2,
				AssignCredits: 0,
				TotalHours: '30 h',
				Requirements: ['SCC0560', 'SSC0510', 'SSC0530'],
				Optional: true,
			},
			{
				Code: 'SSC0581',
			...
			},
			{
				...
				Name: 'Projeto em Intercâmbio I',
				Description:
					'O objetivo desta disciplina é o de permitir ao estudante que desenvolva atividades relevantes para sua formação em empresas ou universidades/centros de pesquisa durante período de intercâmbio oficialmente\nreconhecido.',
				ClassCredits: 4,
				AssignCredits: 8,
				TotalHours: '300 h ( Estágio: 300 h )',
				Requirements: [],
			...
			},
			{
				...
				Description:
					'Apresentar as principais aplicações de Sistemas de Informação nas organizações atuais e os conceitos de Governança e Gestão de Serviços de TI. Trabalho prático envolvendo a análise e o dimensionamento de soluções de SI adequadas ao contexto organizacional.',
				ClassCredits: 4,
				AssignCredits: 1,
				TotalHours: '90 h',
				Requirements: ['SSC0530'],
	...
	},
	{
		...
		Subjects: [
			...
			},
			{
				...
				Description:
					'Familiarizar os alunos com as aplicações de análise a problemas físicos em geral e em   particular à teoria dos circuitos elétricos',
				ClassCredits: 4,
				AssignCredits: 0,
				TotalHours: '60 h',
				Requirements: ['SMA0356', 'SME0240'],
				Optional: true,
			},
			{
				Code: 'SMA0334',
			...
			},
			{
				...
				Description:
					'Desenvolver atividades de estágio nos anos finais do Ensino Fundamental e no Ensino Médio, supervisionado pelo docente responsável, que propiciem à formação do licenciando uma visão geral dos conteúdos de geometria e desenho geométrico para estes níveis de ensino, o contato com experiências, práticas e conhecimentos de natureza profissional, como a elaboração, o planejamento e a execução de atividades de ensino de matemática, sua análise e reestruturação.',
				ClassCredits: 2,
				AssignCredits: 4,
			...
			},
			{
				...
				Description:
					'É objetivo específico da disciplina introduzir ao futuro professor, alguns tópicos da Didática da Matemática, relações entre a história  da educação e o ensino de Matemática, bem como o tratamento detalhado de algumas metodologias específicas para seu ensino',
				ClassCredits: 4,
				AssignCredits: 0,
				TotalHours: '60 h',
				Requirements: null,
			...
			},
			{
				...
				Description:
					'Desenvolver atividades de estágio no Ensino Médio, supervisionado pelo docente responsável, que propiciem àformação do licenciando uma visão geral dos conteúdos de Matemática para estes níveis de ensino, o contato comexperiências, práticas e conhecimentos de natureza profissional, como a elaboração, o planejamento e a execução deatividades de ensino de matemática, sua análise e reestruturação.',
				ClassCredits: 0,
				AssignCredits: 5,
				TotalHours: '150 h ( Estágio: 150 h )',
				Requirements: ['SMA0339', 'SMA0366'],
				Optional: false,
			},
			{
				Code: 'SMA0310',
			...
			},
			{
				...
				Description:
					'Desenvolver atividades de estágio nos anos finais do Ensino Fundamental, supervisionado pelo docente responsável,que propiciem à formação do licenciando uma visão geral dos conteúdos de Matemática para estes níveis de ensino, ocontato com experiências, práticas e conhecimentos de natureza profissional, como a elaboração, o planejamento e aexecução de atividades de ensino de matemática, sua análise e reestruturação.',
				ClassCredits: 0,
				AssignCredits: 5,
				TotalHours: '150 h ( Estágio: 150 h )',
				Requirements: ['SMA0339', 'SMA0365'],
				Optional: false,
			},
			{
				Code: 'SME0220',
